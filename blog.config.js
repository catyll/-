...
const BLOG = {
  AUTHOR: 'Rumboo', // 作者
  BIO: '在世界的角落。', // 作者简介
  LINK: 'rumboo.vercel.app', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'cb2cfe3739e44b1b879670fb40245a86', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  COMMENT_VALINE_PLACEHOLDER: process.env.NEXT_PUBLIC_VALINE_PLACEHOLDER || '請給我評價！', // 可以搭配后台管理评论 https://github.com/DesertsP/Valine-Admin  便于查看评论，以及邮件通知，垃圾评论过滤等功能
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '發酵工房°', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '在世界的角落。', // 站点描述，被notion中的页面描述覆盖
